...
from ultralytics.nn.Addmodules import (Detect_DBB, MultiDilatelocalAttention, iRMB_EMA, C2f_iRMB_EMA, CSPPC,
                                       SPPELAN, ODConv2d, C3_ODConv)

from ultralytics.nn.modules import (AIFI, C1, C2, C3, C3TR, SPP, SPPF, Bottleneck, BottleneckCSP, C2f, C3Ghost, C3x,
                                    Classify, Concat, Conv, Conv2, ConvTranspose, Detect, DWConv, DWConvTranspose2d,
                                    Focus, GhostBottleneck, GhostConv, HGBlock, HGStem, Pose, RepC3, RepConv,
                                    RTDETRDecoder, Segment, CBAM, ScConv, C2f_ScConv, Fusion, C3_ContextGuided,
                                    C2f_ContextGuided, ContextGuidedBlock_Down, SPDConv, C2f_MSBlock)
...
from .modules.SENetV1 import SELayerV1, C2f_SENetV1
from .modules.SENetV2 import SELayerV2, C2f_SENetV2
from .modules.attention import (EMA, DAttention, SEAttention, CoordAtt, TripletAttention, SimAM, SegNext_Attention)
from .modules.SlimNeck import (GSConv, VoVGSCSPC, VoVGSCSP)
from .modules.aDown import ADown
from .modules.C3DualConv import C3_DualConv
from .modules.C2fDualConv import C2f_Dual
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,
                 ...
                 C2f_iRMB_EMA, ScConv, C2f_ScConv,  CSPPC, SPPELAN, C3_ODConv, ODConv2d, C2f_SENetV1, C2f_SENetV2,
                 C3_ContextGuided, C2f_ContextGuided, SPDConv, SEAttention, EMA, C2f_MSBlock, GSConv, VoVGSCSPC, VoVGSCSP,
                 ADown, C3_DualConv, C2f_Dual):
            ...
            args = [c1, c2, *args[1:]]
            if m in (BottleneckCSP, C1, C2, C2f, C3, C3TR, C3Ghost, C3x, RepC3, C2f_iRMB_EMA, C2f_ScConv, CSPPC, C3_ODConv,
                     C2f_SENetV1, C2f_SENetV2, C3_ContextGuided, C2f_ContextGuided, C3_DualConv, C2f_Dual):
                args.insert(2, n)  # number of repeats
                n = 1

        elif m in (CoordAtt, MultiDilatelocalAttention, iRMB_EMA, SEAttention, SELayerV1, SELayerV2, EMA, DAttention,
                   TripletAttention, SegNext_Attention):
            c2 = ch[f]
            args = [c2, *args]
